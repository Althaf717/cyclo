...
AdminRouter.get("/loadsalesReport",auth.isLogin,orderController.loadSalesReport);
AdminRouter.get("/filter-sales", auth.isLogin, orderController.filterSales);
AdminRouter.post("/datewise-filter-sales",auth.isLogin,orderController.dateWiseSales);
AdminRouter.post("/generate-pdf",auth.isLogin,orderController.generateSalesPdf);
AdminRouter.post("/generate-csv",auth.isLogin,orderController.generateSalesCsv);
