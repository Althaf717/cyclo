...
UserRouter.post("/addMoneyWallet",auth.isLogin,walletController.addMoneyWallet);
UserRouter.post("/updateMongoWallet",auth.isLogin,walletController.updateMongoWallet);
UserRouter.post("/useWallet", auth.isLogin, orderController.useWallet);
UserRouter.get("/sumWalletBuynow",auth.isLogin,walletController.sumWalletBuynow);
UserRouter.post("/verifyPayments", auth.isLogin, walletController.varifyPayment)
...
UserRouter.get("/deleteWishlistItem",auth.isLogin,wishlistController.deleteWishlistItem); //delete a item in wish list
UserRouter.get("/getWishlistCount",auth.isLogin,wishlistController.wishlistCount);
...
//___________about_____________________
UserRouter.get("/about",aboutController.aboutpage)
